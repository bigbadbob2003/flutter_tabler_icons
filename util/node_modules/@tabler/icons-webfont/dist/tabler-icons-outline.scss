@charset "UTF-8";
/*!
 * Tabler Icons 3.11.0 by tabler - https://tabler.io
...
@font-face {
  ...
  src: url('#{$ti-font-path}/tabler-icons-outline.woff2?v3.11.0') format('woff2'),
    url('#{$ti-font-path}/tabler-icons-outline.woff?') format('woff'),
    url('#{$ti-font-path}/tabler-icons-outline.ttf?v3.11.0') format('truetype');
}
