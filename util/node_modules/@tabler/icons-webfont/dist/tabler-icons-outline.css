...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url("./fonts/tabler-icons-outline.woff2?v3.0.2") format("woff2"), url("./fonts/tabler-icons-outline.woff?") format("woff"), url("./fonts/tabler-icons-outline.ttf?v3.0.2") format("truetype");
}
.ti {
