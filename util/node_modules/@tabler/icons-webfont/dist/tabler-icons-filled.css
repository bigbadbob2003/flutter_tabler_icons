...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url("./fonts/tabler-icons-filled.woff2?v3.7.0") format("woff2"), url("./fonts/tabler-icons-filled.woff?") format("woff"), url("./fonts/tabler-icons-filled.ttf?v3.7.0") format("truetype");
}
.ti {
